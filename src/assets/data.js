const ROLE_DAMAGE = Symbol()
const ROLE_SUPPORT = Symbol()
const ROLE_HEALER = Symbol()
...
const CHARACTER_ANEMO_TRAVELLER = {
	name: 'Traveller',
	id: 'CHARACTER_ANEMO_TRAVELLER',
	stars: 5,
	element: ELEMENT_ANEMO,
	rating: {
...
const CHARACTER_GEO_TRAVELLER = {
	name: 'Traveller',
	id: 'CHARACTER_GEO_TRAVELLER',
	stars: 5,
	element: ELEMENT_GEO,
	rating: {
		[ROLE_SUPPORT]: [1, 2, 2, 2, 2, 2, 2],
